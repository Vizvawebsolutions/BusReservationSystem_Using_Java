...
public class BusTicketing extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bus Booking System (vcs)");
        jPanel1.add(jLabel1);
        jLabel1.getAccessibleContext().setAccessibleName("  Bus Ticketing  System");
        ...
        jComboBoxDestination.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Destination", "New Delhi", "Mumbai", "Hydrabad", "Pune", "Bihar", "Chandigarh" }));
        jComboBoxDestination.addContainerListener(new java.awt.event.ContainerAdapter() {
            public void componentAdded(java.awt.event.ContainerEvent evt) {
                jComboBoxDestinationComponentAdded(evt);
            }
        });
   ...
   if(jComboBoxTime.getSelectedItem().equals("11:30")){
    ...
    private void jComboBoxDestinationComponentAdded(java.awt.event.ContainerEvent evt) {//GEN-FIRST:event_jComboBoxDestinationComponentAdded
        // TODO add your handling code here:
    }//GEN-LAST:event_jComboBoxDestinationComponentAdded
